...
--
-- Table structure for table `g1_users`
--

DROP TABLE IF EXISTS `g1_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `g1_users` (
...
--
-- Table structure for table `g2_users`
--

DROP TABLE IF EXISTS `g2_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `g2_users` (
  `username` varchar(255) DEFAULT NULL,
  `user_type` varchar(255) DEFAULT NULL
) ENGINE=InnoDB;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `saif1090saif123`
--

DROP TABLE IF EXISTS `saif1090saif123`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saif1090saif123` (
  `fromwho` varchar(1000) DEFAULT NULL,
  `message` varchar(1000) DEFAULT NULL,
...
-- Dump completed on 2026-06-02 22:43:14
